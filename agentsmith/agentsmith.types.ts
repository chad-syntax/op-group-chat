...
|--------------------------------------------|
*/
export type PromptVariables__chat_prompt__0_0_6 = never;
export type PromptVariables__chat_prompt__0_0_5 = never;
export type PromptVariables__chat_prompt__0_0_4 = never;
export type PromptVariables__chat_prompt__0_0_3 = never;
...
export type PromptVariables__hello_world__1_0_0 = never;
...
export type PromptVariables__test_include_partial__0_0_3 = {
  name: string;
};
...
export type PromptVariables__test_prompt_non_chat__0_0_7 = {
  alignment: string;
};
export type PromptVariables__test_prompt_non_chat__0_0_6 = {
  alignment: string;
};
export type PromptVariables__test_prompt_non_chat__0_0_5 = {
  alignment: string;
};
export type PromptVariables__test_prompt_non_chat__0_0_4 = {
  alignment: string;
};
export type PromptVariables__test_prompt_non_chat__0_0_3 = {
  alignment: string;
};
export type PromptVariables__test_prompt_non_chat__0_0_2 = {
  alignment: string;
};
export type PromptVariables__test_prompt_non_chat__0_0_1 = {
  alignment: string;
};
export type PromptVariables__usopp__0_0_1 = {
  thread: any;
};
export type PromptConfig__chat_prompt__0_0_6 = {
  models: ['qwen/qwen3-30b-a3b-instruct-2507'];
  stream: true;
};
export type PromptVersion__chat_prompt__0_0_6 = {
  version: '0.0.6';
  config: PromptConfig__chat_prompt__0_0_6;
  variables: PromptVariables__chat_prompt__0_0_6 & PromptVariables__test_prompt_non_chat__0_0_4;
  content: string;
};
export type PromptConfig__chat_prompt__0_0_5 = {
  models: ['qwen/qwen3-30b-a3b-instruct-2507'];
  stream: true;
  temperature: number;
};
export type PromptVersion__chat_prompt__0_0_5 = {
  version: '0.0.5';
  config: PromptConfig__chat_prompt__0_0_5;
  variables: PromptVariables__chat_prompt__0_0_5;
  content: string;
};
export type PromptConfig__chat_prompt__0_0_4 = {
  models: ['qwen/qwen3-30b-a3b-instruct-2507'];
  stream: true;
  temperature: number;
};
export type PromptVersion__chat_prompt__0_0_4 = {
  version: '0.0.4';
  config: PromptConfig__chat_prompt__0_0_4;
  variables: PromptVariables__chat_prompt__0_0_4;
  content: string;
};
export type PromptConfig__chat_prompt__0_0_3 = {
  models: ['qwen/qwen3-30b-a3b-instruct-2507'];
  stream: true;
  temperature: number;
};
export type PromptVersion__chat_prompt__0_0_3 = {
  version: '0.0.3';
  config: PromptConfig__chat_prompt__0_0_3;
  variables: PromptVariables__chat_prompt__0_0_3;
  content: string;
};
export type PromptConfig__chat_prompt__0_0_2 = {
  models: ['qwen/qwen3-30b-a3b-instruct-2507', 'deepseek/deepseek-r1-0528:free', 'openai/gpt-5'];
  stream: true;
  temperature: number;
};
...
export type Prompt__chat_prompt = {
  ...
  slug: 'chat-prompt';
  versions: {
    latest: PromptVersion__chat_prompt__0_0_1;
    '0.0.6': PromptVersion__chat_prompt__0_0_6;
    '0.0.5': PromptVersion__chat_prompt__0_0_5;
    '0.0.4': PromptVersion__chat_prompt__0_0_4;
    '0.0.3': PromptVersion__chat_prompt__0_0_3;
...
export type PromptConfig__test_include_partial__0_0_3 = {
  models: ['google/gemini-2.5-flash-lite-preview-06-17'];
  temperature: number;
};
export type PromptVersion__test_include_partial__0_0_3 = {
  version: '0.0.3';
  config: PromptConfig__test_include_partial__0_0_3;
  variables: PromptVariables__test_include_partial__0_0_3 &
...
export type Prompt__test_include_partial = {
  ...
  versions: {
    latest: PromptVersion__test_include_partial__0_0_2;
    '0.0.3': PromptVersion__test_include_partial__0_0_3;
...
export type PromptConfig__test_prompt_non_chat__0_0_7 = {
  models: ['moonshotai/kimi-k2'];
  stream: true;
  temperature: number;
};
export type PromptVersion__test_prompt_non_chat__0_0_7 = {
  version: '0.0.7';
  config: PromptConfig__test_prompt_non_chat__0_0_7;
  variables: PromptVariables__test_prompt_non_chat__0_0_7;
  content: string;
};
export type PromptConfig__test_prompt_non_chat__0_0_6 = {
  models: ['moonshotai/kimi-k2'];
  temperature: number;
};
export type PromptVersion__test_prompt_non_chat__0_0_6 = {
  version: '0.0.6';
  config: PromptConfig__test_prompt_non_chat__0_0_6;
  variables: PromptVariables__test_prompt_non_chat__0_0_6;
  content: string;
};
export type PromptConfig__test_prompt_non_chat__0_0_5 = {
  models: ['moonshotai/kimi-k2'];
  temperature: number;
};
export type PromptVersion__test_prompt_non_chat__0_0_5 = {
  version: '0.0.5';
  config: PromptConfig__test_prompt_non_chat__0_0_5;
  variables: PromptVariables__test_prompt_non_chat__0_0_5;
  content: string;
};
export type PromptConfig__test_prompt_non_chat__0_0_4 = {
  models: ['moonshotai/kimi-k2'];
  temperature: number;
};
export type PromptVersion__test_prompt_non_chat__0_0_4 = {
  version: '0.0.4';
  config: PromptConfig__test_prompt_non_chat__0_0_4;
  variables: PromptVariables__test_prompt_non_chat__0_0_4;
  content: string;
};
export type PromptConfig__test_prompt_non_chat__0_0_3 = {
  models: ['moonshotai/kimi-k2'];
  temperature: number;
};
export type PromptVersion__test_prompt_non_chat__0_0_3 = {
  version: '0.0.3';
  config: PromptConfig__test_prompt_non_chat__0_0_3;
  variables: PromptVariables__test_prompt_non_chat__0_0_3;
  content: string;
};
export type PromptConfig__test_prompt_non_chat__0_0_2 = {
  models: ['moonshotai/kimi-k2'];
  temperature: number;
};
export type PromptVersion__test_prompt_non_chat__0_0_2 = {
  version: '0.0.2';
  config: PromptConfig__test_prompt_non_chat__0_0_2;
  variables: PromptVariables__test_prompt_non_chat__0_0_2;
  content: string;
};
export type PromptConfig__test_prompt_non_chat__0_0_1 = {
  models: ['moonshotai/kimi-k2'];
};
export type PromptVersion__test_prompt_non_chat__0_0_1 = {
  version: '0.0.1';
  config: PromptConfig__test_prompt_non_chat__0_0_1;
  variables: PromptVariables__test_prompt_non_chat__0_0_1;
  content: string;
};
export type Prompt__test_prompt_non_chat = {
  name: 'test prompt non-chat';
  slug: 'test-prompt-non-chat';
  versions: {
    latest: never;
    '0.0.7': PromptVersion__test_prompt_non_chat__0_0_7;
    '0.0.6': PromptVersion__test_prompt_non_chat__0_0_6;
    '0.0.5': PromptVersion__test_prompt_non_chat__0_0_5;
    '0.0.4': PromptVersion__test_prompt_non_chat__0_0_4;
    '0.0.3': PromptVersion__test_prompt_non_chat__0_0_3;
    '0.0.2': PromptVersion__test_prompt_non_chat__0_0_2;
    '0.0.1': PromptVersion__test_prompt_non_chat__0_0_1;
  };
};
...
export type Agency = {
  prompts: {
    ...
    'test-prompt-non-chat': Prompt__test_prompt_non_chat;
    usopp: Prompt__usopp;
  };
  globals: Globals;
};
