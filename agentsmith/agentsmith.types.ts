...
|--------------------------------------------|
*/
export type PromptVariables__hello_world__3_0_2 = never;
export type PromptVariables__hello_world__3_0_1 = {
  name: string;
};
...
export type PromptVersion__hello_world__3_0_2 = {
  version: '3.0.2';
  config: PromptConfig__hello_world__3_0_2;
  variables: PromptVariables__hello_world__3_0_2;
  content: string;
};
export type PromptConfig__hello_world__3_0_1 = {
